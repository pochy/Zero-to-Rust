...
`WARNING` は、処理は続けるが運用者に注意を促すログや表示です。この演習ではログ形式を実装する必要はなく、どの失敗を止めるべきかを考えます。
...
[CHECKPOINTS.md](../../docs/guide/CHECKPOINTS.md) の Level 8 を A/B/C で自己評価してください。
...
`runbook` は、障害時に何を確認し、どう判断し、どう復旧するかを書いた手順書です。
